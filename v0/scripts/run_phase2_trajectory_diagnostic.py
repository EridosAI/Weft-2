...
_DEFAULT_ANNOT = REPO_ROOT / "v0/data" / "phase2_calibration_v2" / "annotations.jsonl"
_DEFAULT_FRAMES = REPO_ROOT / "v0/data" / "phase2_calibration_v2" / "frames"
_DEFAULT_OUT_JSON = REPO_ROOT / "v0/results" / "phase2_calibration_v2" / "trajectory_diagnostic.json"
_DEFAULT_OUT_FRAMES = REPO_ROOT / "v0/results" / "phase2_calibration_v2" / "discontinuity_frames"
