...
from shared.encoder.dinov2_encoder import (  # noqa: E402
    encode_frames,
    load_frozen_dinov2,
)
...
def main() -> int:
    ...
    parser.add_argument("--frames_dir", type=Path,
                        default=REPO_ROOT / "v0/data/phase2_calibration/frames")
    parser.add_argument("--annotations", type=Path,
                        default=REPO_ROOT / "v0/data/phase2_calibration/annotations.jsonl")
    parser.add_argument("--out_embeddings", type=Path,
                        default=REPO_ROOT / "v0/data/phase2_calibration/embeddings.npy")
    parser.add_argument("--out_report", type=Path,
                        default=REPO_ROOT / "v0/results/phase2_calibration/continuity_report.json")
