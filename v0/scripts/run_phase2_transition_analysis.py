...
def main() -> int:
    ...
    parser.add_argument(
        "--diagnostic",
        type=Path,
        default=REPO_ROOT / "v0/results/inner_pam_v0/phase2_main/transition_diagnostic.json",
    )
    parser.add_argument(
        "--out",
        type=Path,
        default=REPO_ROOT / "v0/results/inner_pam_v0/phase2_main/transition_g2t2_restructured.json",
    )
