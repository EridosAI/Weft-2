...
from v0.src.config import EMBED_DIM, PREDICT_K, WINDOW_W  # noqa: E402
from v0.src.predictor.inner_pam import InnerPAM  # noqa: E402

ANNOT_PATH = REPO_ROOT / "v0/data/phase2_annotations.jsonl"
EMB_PATH = REPO_ROOT / "v0/data/phase2_embeddings/embeddings.npy"
PHASE2_DIR = REPO_ROOT / "v0/results/inner_pam_v0/phase2_main"
