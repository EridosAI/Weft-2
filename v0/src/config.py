...
class Paths:
    repo: Path = REPO_ROOT
    embeddings: Path = REPO_ROOT / "v0/data/dinov2_embeddings/embeddings.npy"
    embeddings_dwell_archive: Path = (
        REPO_ROOT / "v0/data/dinov2_embeddings/embeddings_dwell_only_v1.npy"
    )
    annotations_phase1: Path = Path(
        "/mnt/c/Users/Jason/Desktop/Eridos/Weft/results/stage_0b_furniture/main/"
        "frame_annotations.jsonl"
    )
    phase2_frames: Path = REPO_ROOT / "v0/data/phase2_frames"
    phase2_annotations: Path = REPO_ROOT / "v0/data/phase2_annotations.jsonl"
    phase2_embeddings: Path = REPO_ROOT / "v0/data/phase2_embeddings/embeddings.npy"
    phase3_frames: Path = REPO_ROOT / "v0/data/phase3_frames"
    phase3_annotations: Path = REPO_ROOT / "v0/data/phase3_annotations.jsonl"
    phase3_embeddings: Path = REPO_ROOT / "v0/data/phase3_embeddings/embeddings.npy"
    results_phase1_main: Path = REPO_ROOT / "v0/results/inner_pam_v0/phase1_main"
    results_phase1_shuffle: Path = REPO_ROOT / "v0/results/inner_pam_v0/phase1_shuffle"
    results_phase2_main: Path = REPO_ROOT / "v0/results/inner_pam_v0/phase2_main"
    results_phase2_shuffle: Path = REPO_ROOT / "v0/results/inner_pam_v0/phase2_shuffle"
    results_phase2_preflight: Path = REPO_ROOT / "v0/results/inner_pam_v0/phase2_preflight"
    results_phase3_main: Path = REPO_ROOT / "v0/results/inner_pam_v0/phase3_main"
    results_phase3_shuffle: Path = REPO_ROOT / "v0/results/inner_pam_v0/phase3_shuffle"
    results_phase3_preflight: Path = REPO_ROOT / "v0/results/inner_pam_v0/phase3_preflight"
    results_developmental_arc: Path = (
        REPO_ROOT / "v0/results/inner_pam_v0/developmental_arc"
    )
